...
router.post('/authU', userController.authUser);
router.post('/getSRated', songRatingController.getRatingsByUser);
router.post('/autoC', artistsController.autoSuggestArtistName);
router.post('/checkA', artistsController.checkArtist);
router.post('/checkS', songsController.checkSong);
